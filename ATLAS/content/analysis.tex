...
\ref{fig:5} and figure \ref{fig:6}. The discriminants $\Delta\phi$, $m(3j)$ and $\eta(4j,\,l,\,\nu)$ have similar distributions for both samples where the main difference are the larger fluctuation 
...
\begin{figure}[H]%
  \begin{subfigure}{0.48\textwidth}%
    ...
    \caption{$p_\text{T, miss}$, $Z^\prime(1000 \, \si{\giga\eV})$}%
    \label{fig:5a}%
  \end{subfigure}%
  \hfill
  \begin{subfigure}{0.48\textwidth}%
    ...
    \caption{$p_\text{T, miss}$, $t \overline{t}$}%
    \label{fig:5b}%
  \end{subfigure}%
  ...
  \begin{subfigure}{0.45\textwidth}%
    ...
    \caption{$\Delta\phi$, $Z^\prime(1000 \, \si{\giga\eV})$}%
    \label{fig:5c}%
  \end{subfigure}%
  \hfill
  \begin{subfigure}{0.45\textwidth}%
    ...
    \caption{$\Delta\phi$, $t \overline{t}$}%
    \label{fig:5d}%
  \end{subfigure}%
  ...
  \begin{subfigure}{0.45\textwidth}%
    ...
    \caption{$m(3j)$, $Z^\prime(1000 \, \si{\giga\eV})$}%
    \label{fig:5e}%
  \end{subfigure}%
  \hfill
  \begin{subfigure}{0.45\textwidth}%
...
\begin{figure}[H]%
  ...
  \begin{subfigure}{0.45\textwidth}%
    ...
    \label{fig:6h}%
  \end{subfigure}%
  \caption{Stacked plots of the fundamental distributions investigated in Section \ref{sec:sekunde} with all simulated Standard Model backgrounds which include an electron.}%
  \label{fig:6}%
\end{figure}
...
\begin{figure}[tb]
  ...
  \caption{Stacked plot of the discriminant $m(4j,\,l,\,\nu)$ with all simulated Standard Model backgrounds which include an electron.}
  \label{fig:7}
\end{figure}
