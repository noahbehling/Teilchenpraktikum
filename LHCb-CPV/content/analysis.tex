...
Since the measured final state particles in the real data contain a background where the particles are other particles than hadrons the probability that the 
