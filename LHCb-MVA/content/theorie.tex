...
%The $K^0_\mathrm{S}$ has as quark content a superposition of $d \overline{s}$ and $\overline{d}s$. The dominant decay mode, which will be used in the analysis,
%is $K^0_\mathrm{S} \rightarrow \pi^+ \pi^-$ with a branching fraction of $\mathcal{B}(K^0_\mathrm{S} \rightarrow \pi^+ \pi^-) = (69.20 \pm 0.05) \, \%$ \cite{pdg}. \\
